...
public class FailnaughtItem extends LivingwoodBowItem implements LensEffectItem {
    ...
    public InteractionResultHolder<ItemStack> use(Level world, Player player, InteractionHand hand) {
        ...
        InteractionResultHolder<ItemStack> ret = ForgeEventFactory.onArrowNock(itemstack, world, player, hand, false);
    ...
    * */
    ...
    public boolean isBookEnchantable(ItemStack stack, ItemStack book) {
        return EnchantedBookItem.getEnchantments(book).stream()
                .map(tag -> (CompoundTag)tag)
                .map(tag -> BuiltInRegistries.ENCHANTMENT.get(ResourceLocation.parse(tag.getString("id"))))
                .anyMatch(SUPPORT_ENCHANTMENTS::contains);
    }
}
