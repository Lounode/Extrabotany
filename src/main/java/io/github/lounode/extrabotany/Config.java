...
public class Config
{
    ...
    private static final ForgeConfigSpec.IntValue NIGHTMARE_FUEL_BURN_TIME = BUILDER
            .comment("Nightmare fuel burn time")
            .defineInRange("nightmareFuelBurnTime", 3200, 0, Integer.MAX_VALUE);
