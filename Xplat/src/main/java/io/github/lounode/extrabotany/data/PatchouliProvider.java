...
public class PatchouliProvider implements DataProvider {
    ...
    private static final ResourceLocation EXTRA_BOTANY_CATEGORY = new ResourceLocation("botania","extrabotanies");
    ...
    public CompletableFuture<?> run(CachedOutput cache) {
        ...
        PatchouliEntry entry = new PatchouliEntry(
                ...
                new ResourceLocation("extrabotany", nameKey))
    ...
    private ResourceLocation getPath(String namespace,String book, String category, String fileName) {
        return new ResourceLocation(namespace, Path.of(book, "en_us/entries", category, fileName).toString().replace("\\","/"));
    }
