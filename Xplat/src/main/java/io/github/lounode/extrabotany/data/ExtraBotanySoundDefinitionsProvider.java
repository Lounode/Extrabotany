...
public class ExtraBotanySoundDefinitionsProvider extends SoundDefinitionsProvider{
    ...
    public void registerSounds() {
        ...
        take(soundEvents, ExtraBotanySounds.EXCALIBUR_ATTACK);
        take(soundEvents, ExtraBotanySounds.FAILNAUGHT_SHOOT);
        take(soundEvents, ExtraBotanySounds.FEATHER_OF_JINGWEI_SHOOT);

        this.add(ExtraBotanySounds.EXCALIBUR_ATTACK, SoundDefinitionsProvider.definition()
                .subtitle(title(ExtraBotanySounds.EXCALIBUR_ATTACK))
                .with(
        ...
        this.add(ExtraBotanySounds.FAILNAUGHT_SHOOT, SoundDefinitionsProvider.definition()
                .subtitle(title(ExtraBotanySounds.FAILNAUGHT_SHOOT))
                .with(
                        SoundDefinitionsProvider.sound(BotaniaSounds.terraBlade.getLocation())
                                .volume(0.4f)
                                .pitch(1.4f)
        ...
        this.add(ExtraBotanySounds.FEATHER_OF_JINGWEI_SHOOT, SoundDefinitionsProvider.definition()
                .subtitle(title(ExtraBotanySounds.FEATHER_OF_JINGWEI_SHOOT))
                .with(
